          ...
          projects: [
            ...
            },
            {
              ...
              content: (
                <Card
                  title="VARCO UI 개발"
                  description="VARCO 서비스(VARCO Text, VARCO Art 등)에서 사용되는 공통 컴포넌트입니다. 디자인 시스템을 기반으로 개발되었습니다."
                />
              ),
            },
            {
          ...
          projects: [
            {
              ...
              content: (
                <Card
                  ...
                  description="디자인 시스템을 직접 제작하고 제작한 디자인 시스템을 가이드라인으로 공통 컴포넌트를 개발했습니다."
                />
              ),
            },
            {
              ...
              content: (
                <Card
                  ...
                  description="음성 AI 기술을 활용한 음성 합성 서비스로, AI 기술의 가능성을 보여주는데 중점을 둔 프로토타입 목적의 서비스입니다. 업로드된 이미지 혹은 음성을 기반으로 AI가 음성을 생성하고 생성한 음성의 어조, 성별, 나이를 편집할 수 있습니다.."
                />
              ),
            },
          ],
          ...
          projects: [
            {
              ...
              content: (
                <Card
                  ...
                  description="웹 기반의 메타버스 플랫폼입니다. 사용자는 줌과 같은 화상 채팅 기능을 통해 실시간 소통을 할 수 있으며, 로블록스와 유사하게 자신만의 가상공간을 구축하거나 게임을 개발할 수 있는 기능을 제공합니다. "
                />
              ),
            },
          ],
          ...
          projects: [
            {
              ...
              content: (
                <Card
                  ...
                  description="리니지2M 공성전의 로그 데이터를 활용한 Canvas 기반 공성전 시각화 서비스입니다."
                />
              ),
            },
          ],
          ...
          projects: [
            {
              ...
              content: (
                <Card
                  ...
                  description="이마트 광고제휴 시스템, 세금 계산서 시스템, MMS 쿠폰 시스템 운영하고 기능을 추가하여 서비스를 개선했습니다."
                />
              ),
            },
          ],
